...
mixin _$AppUser {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, uid, isAnonymous, email, displayName);

  @override
  String toString() {
    return 'AppUser(uid: $uid, isAnonymous: $isAnonymous, email: $email, displayName: $displayName)';
  }
}
...
abstract mixin class $AppUserCopyWith<$Res> {
  ...
  @useResult
  $Res call({String uid, bool isAnonymous, String? email, String? displayName});
}
...
extension AppUserPatterns on AppUser {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(
            String uid, bool isAnonymous, String? email, String? displayName)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _AppUser() when $default != null:
        return $default(
            _that.uid, _that.isAnonymous, _that.email, _that.displayName);
      case _:
        return orElse();
    }
  }
