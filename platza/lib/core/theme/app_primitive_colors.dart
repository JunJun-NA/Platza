...
/// Figma "Primitive Color" コレクションから生成されたカラーパレット
///
/// Figma Variables と 1:1 で対応。
/// セマンティックカラー（AppColors）はこれらを参照する形で使用する。
class AppPrimitiveColors {
  ...
  // White / Black
  // =========================================
  static const Color white = Color(0xFFFFFFFF);   // grey/0
  static const Color black = Color(0xFF000000);   // grey/1000
  ...
  static const Color blueGrey100 = Color(0xFFCFDCD3);
  static const Color blueGrey200 = Color(0xFFB0C5B7);
  ...
  static const Color blueGreyA100 = Color(0xFFCFD8DC);
  static const Color blueGreyA200 = Color(0xFFB0BEC5);
  static const Color blueGreyA400 = Color(0xFF78909C);
  static const Color blueGreyA700 = Color(0xFF455A64);
  ...
  static const Color greyA100 = Color(0xFFF5F5F5);
  static const Color greyA200 = Color(0xFFEEEEEE);
  static const Color greyA300 = Color(0xFF757575);
  static const Color greyA400 = Color(0xFFBDBDBD);
  static const Color greyA700 = Color(0xFF616161);
  ...
  static const Color lightGreen400 = Color(0xFF8BC34A);
  ...
  // Red
  // =========================================
  static const Color red50 = Color(0xFFFEEBEE);
  static const Color red100 = Color(0xFFFECDD2);
